...
prepare_worktree() {
  ...
  (
    ...
    echo "  DEEPER_NOTEBOOK_BASE_URL=http://127.0.0.1:3100 DEEPER_NOTEBOOK_FIXTURE_API_PORT=5055 node output/playwright/onp-visual-smoke.mjs"
  )
}
