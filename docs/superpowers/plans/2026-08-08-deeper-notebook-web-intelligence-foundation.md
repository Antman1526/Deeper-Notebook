...
def test_fingerprint_is_deterministic_and_changes_with_source_content():
    ...
    first = normalize_web_results([{"title": "T", "url": "https://example.com", "snippet": "S"}], query="q", provider="tavily", retrieved_at=now)[0]
    same = normalize_web_results([{"title": "T", "url": "https://example.com", "snippet": "S"}], query="q", provider="tavily", retrieved_at=now + timedelta(seconds=1))[0]
    changed = normalize_web_results([{"title": "T", "url": "https://example.com", "snippet": "different"}], query="q", provider="tavily", retrieved_at=now)[0]
