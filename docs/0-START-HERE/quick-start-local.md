...
Get Deeper Notebook running with **100% local AI** using Ollama. No cloud API keys needed, completely private.
...
## Step 5: Access Deeper Notebook (instant)
...
4. In Deeper Notebook, go to **Settings** → **API Keys**
