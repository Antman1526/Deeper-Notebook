...
Step-by-step guides for common types of changes in the Deeper Notebook codebase. Each playbook lists the files to touch **in order**, what to do at each step, and what to test.
