# Deeper Notebook Architecture

## High-Level Overview

Deeper Notebook follows a three-tier architecture with clear separation of concerns:
...
LangGraph is a state machine library that orchestrates multi-step AI workflows. Deeper Notebook uses five core workflows:
