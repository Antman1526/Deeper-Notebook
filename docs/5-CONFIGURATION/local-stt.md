...
> - **[docker-compose-speaches.yml](../../examples/docker-compose-speaches.yml)** - Speaches + Deeper Notebook
...
### Step 4: Configure Deeper Notebook
...
```yaml
# In your Deeper Notebook docker-compose.yml
environment:
...
### Step 5: Add Model in Deeper Notebook
...
### Deeper Notebook in Docker (macOS/Windows)

**STT Base URL:** `http://host.docker.internal:8969/v1`

### Deeper Notebook in Docker (Linux)
...
# From inside Deeper Notebook container
