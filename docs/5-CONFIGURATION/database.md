...
Deeper Notebook uses SurrealDB for its database needs.

---

## Default Configuration

Deeper Notebook should work out of the box with SurrealDB as long as the environment variables are correctly setup.


### DB running in the same docker compose as Deeper Notebook (recommended)
...
### DB running in the host machine and Deeper Notebook running in Docker
...
### Deeper Notebook and Surreal are running on the same machine
