...
Comprehensive list of all environment variables available in Deeper Notebook.
...
| `OPEN_NOTEBOOK_PASSWORD` | No | None | Password to protect Deeper Notebook instance |
...
| `LANGCHAIN_PROJECT` | No | Deeper Notebook | LangSmith project name |
