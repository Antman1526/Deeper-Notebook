...
LANGCHAIN_PROJECT="Deeper Notebook"
```
...
```env
# Protect your Deeper Notebook instance
...
Restrict access to your Deeper Notebook:
...
Deeper Notebook uses multiple services for content extraction:
