...
Before diving into how to use Deeper Notebook, it's important to understand **how it thinks**. These core concepts explain the "why" behind the design.

## The Five Mental Models

### 1. [Notebooks, Sources, and Notes](notebooks-sources-notes.md)
How Deeper Notebook organizes your research. Understand the three-tier container structure and how information flows from raw materials to finished insights.
...
How Deeper Notebook makes AI aware of your research - two different approaches.
...
Why Deeper Notebook has different interaction modes and when to use each one.
...
Why Deeper Notebook can turn research into audio and why this matters.
...
- **You're new to Deeper Notebook** — Start here to understand how the system works conceptually before learning the features
...
Deeper Notebook is built on a simple insight: **Your research deserves to stay yours**.
