...
describe('VaultMarkdown', () => {
  it('renders markdown without executing raw HTML and navigates resolved wikilinks', () => {
    ...
    render(<VaultMarkdown markdown={'# Plan\n\n[[Research]]\n\n<img src=x onerror=alert(1)>'} links={[{ id: 'link:1', source_note_id: 'note:one', target_note_id: 'note:two', target_text: 'Research', link_kind: 'wikilink', resolved: true }]} onNavigate={onNavigate} />)
