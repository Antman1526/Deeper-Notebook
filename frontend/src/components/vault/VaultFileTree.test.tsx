...
describe('VaultFileTree', () => {
  it('filters files and opens a selected note', () => {
    ...
    render(<VaultFileTree files={[{ id: 'vault_file:one', note_id: 'note:actual-derived-id', vault_id: 'v', relative_path: 'Projects/Plan.md', file_kind: 'markdown', format: 'obsidian', content_hash: null, parse_status: 'parsed' }]} selectedNoteId="" onSelect={onSelect} />)
