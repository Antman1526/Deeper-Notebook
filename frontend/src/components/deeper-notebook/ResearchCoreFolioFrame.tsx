...
export function ResearchCoreFolioFrame({
  ...
  return (
    <div className="research-core-folio flex min-h-0 min-w-0 flex-1 flex-col" data-testid="research-core-folio">
      ...
      <div className="research-core-folio__spread min-h-0 flex-1" data-testid="research-core-folio-spread">
        ...
        <div className="research-core-folio__workspace min-h-0 w-full max-w-full min-w-0" data-testid="research-core-folio-workspace">{workspace}</div>
