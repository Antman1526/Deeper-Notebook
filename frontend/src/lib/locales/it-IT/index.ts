export const itIT = {
  ...
  filesystem: {
    ...
    documents: "Documenti",
    downloads: "Download",
    defaultExports: "Esportazioni ONP",
  ...
  settings: {
    ...
    launcherPrefs: {
      ...
      draftModelPathDesc: "Percorso assoluto di un GGUF ridotto per la decodifica speculativa di llama.cpp (OPEN_NOTEBOOK_LOCAL_DRAFT_MODEL_PATH). Lascia vuoto per disabilitare.",
      draftNPredictLabel: "Token draft per verifica",
      draftNPredictPlaceholder: "8",
      draftNPredictDesc: "OPEN_NOTEBOOK_LOCAL_DRAFT_N_PREDICT. Default 8.",
      nCtxLabel: "Finestra di contesto locale (n_ctx)",
      nCtxPlaceholder: "32768",
      nCtxDesc: "ONP_CHAT_LLM_CTX. Sovrascrive la lunghezza di contesto rilevata automaticamente dal GGUF. Lascia vuoto per la rilevazione automatica.",
      nCtxMaxLabel: "Limite massimo contesto (n_ctx_max)",
      nCtxMaxPlaceholder: "32768",
      nCtxMaxDesc: "ONP_CHAT_LLM_CTX_MAX. Limite superiore per il rilevamento automatico. Default 32768.",
  ...
  setupBanner: {
    ...
    degraded: "Open notebook+ è in esecuzione in stato degradato",
