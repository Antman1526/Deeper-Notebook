export const frFR = {
  ...
  settings: {
    ...
    launcherPrefs: {
      ...
      draftModelPathDesc: "Chemin absolu d'un petit GGUF pour le décodage spéculatif llama.cpp (OPEN_NOTEBOOK_LOCAL_DRAFT_MODEL_PATH). Laisser vide pour désactiver.",
      draftNPredictLabel: "Tokens brouillon par vérification",
      draftNPredictPlaceholder: "8",
      draftNPredictDesc: "OPEN_NOTEBOOK_LOCAL_DRAFT_N_PREDICT. Valeur par défaut : 8.",
      nCtxLabel: "Fenêtre de contexte locale (n_ctx)",
      nCtxPlaceholder: "32768",
      nCtxDesc: "ONP_CHAT_LLM_CTX. Remplace la longueur de contexte auto-détectée du GGUF. Laisser vide pour l'auto-détection.",
      nCtxMaxLabel: "Plafond de contexte (n_ctx_max)",
      nCtxMaxPlaceholder: "32768",
      nCtxMaxDesc: "ONP_CHAT_LLM_CTX_MAX. Limite supérieure de l'auto-détection. Par défaut : 32768.",
  ...
  setupBanner: {
    ...
    degraded: "Open notebook+ fonctionne en mode dégradé",
