export const ruRU = {
  ...
  settings: {
    ...
    launcherPrefs: {
      ...
      draftModelPathDesc: "Абсолютный путь к небольшому GGUF для спекулятивного декодирования llama.cpp (OPEN_NOTEBOOK_LOCAL_DRAFT_MODEL_PATH). Оставьте пустым для отключения.",
      draftNPredictLabel: "Токенов на проверку",
      draftNPredictPlaceholder: "8",
      draftNPredictDesc: "OPEN_NOTEBOOK_LOCAL_DRAFT_N_PREDICT. По умолчанию 8.",
      nCtxLabel: "Локальное контекстное окно (n_ctx)",
      nCtxPlaceholder: "32768",
      nCtxDesc: "ONP_CHAT_LLM_CTX. Переопределяет автоопределённую длину контекста GGUF. Оставьте пустым для автоопределения.",
      nCtxMaxLabel: "Максимальный контекст (n_ctx_max)",
      nCtxMaxPlaceholder: "32768",
      nCtxMaxDesc: "ONP_CHAT_LLM_CTX_MAX. Верхняя граница автоопределения. По умолчанию 32768.",
  ...
  setupBanner: {
    ...
    degraded: "Open notebook+ работает в режиме пониженной готовности",
