export const bnIN = {
  ...
  knowledge: { mounts: "মাউন্ট করা ভল্ট", scan: "ভল্ট স্ক্যান করুন", status: "অবস্থা", readOnly: "শুধু-পঠনযোগ্য বাহ্যিক ফাইল", backlinks: "ব্যাকলিংক", outgoing: "আউটগোয়িং লিংক", properties: "বৈশিষ্ট্য", tags: "ট্যাগ", unresolved: "অমীমাংসিত লিংক", loadError: "জ্ঞান লোড করা যায়নি।", description: "মূল ফাইল পরিবর্তন না করে স্থানীয় Obsidian ও Logseq নোট পড়ুন।", files: "ভল্ট ফাইল", mountsLoading: "মাউন্ট করা ভল্ট লোড হচ্ছে…", noMounts: "এখনও কোনো মাউন্ট করা ভল্ট উপলভ্য নেই।", filesLoading: "ফাইল লোড হচ্ছে…", reader: "পাঠক", localGraph: "স্থানীয় গ্রাফ", selectNote: "অন্বেষণ করতে একটি নোট নির্বাচন করুন", externalReadOnly: "আপনার ভল্ট বাহ্যিক ও শুধু-পঠনযোগ্য থাকে।", noteLoading: "নোট লোড হচ্ছে…", untitledNote: "শিরোনামহীন নোট", canonicalSource: "প্রামাণিক উৎস", noProperties: "কোনো বৈশিষ্ট্য নেই।", noTags: "কোনো ট্যাগ নেই।", outline: "রূপরেখা", graphLoading: "গ্রাফ লোড হচ্ছে…", graphLoadError: "গ্রাফ লোড করা যায়নি।", noteLinks: "নোট লিংক", linksLoading: "লিংক লোড হচ্ছে…", linksLoadError: "লিংক লোড করা যায়নি।", filterFiles: "ফাইল ছাঁকুন", noMatchingFiles: "কোনো মিল থাকা ফাইল নেই।", noGraphLinks: "মানচিত্রে দেখানোর মতো নোট লিংক নেই।", noLinks: "এখনও কোনো লিংক নেই।" },
  notebooks: {
    title: "নোটবুকগুলি",
    newNotebook: "নতুন নোটবুক",
