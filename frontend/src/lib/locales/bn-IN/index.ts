export const bnIN = {
  ...
  settings: {
    ...
    launcherPrefs: {
      ...
      draftModelPathDesc: "llama.cpp স্পেকুলেটিভ ডিকোডিংয়ের জন্য ছোট GGUF-এর পরম পাথ (OPEN_NOTEBOOK_LOCAL_DRAFT_MODEL_PATH)। নিষ্ক্রিয় করতে খালি রাখুন।",
      draftNPredictLabel: "প্রতি যাচাইয়ে ড্রাফট টোকেন",
      draftNPredictPlaceholder: "8",
      draftNPredictDesc: "OPEN_NOTEBOOK_LOCAL_DRAFT_N_PREDICT। ডিফল্ট ৮।",
      nCtxLabel: "স্থানীয় কনটেক্সট উইন্ডো (n_ctx)",
      nCtxPlaceholder: "32768",
      nCtxDesc: "ONP_CHAT_LLM_CTX। GGUF থেকে স্বয়ংক্রিয়-সনাক্ত কনটেক্সট দৈর্ঘ্য ওভাররাইড করে। স্বয়ংক্রিয়-সনাক্তের জন্য খালি রাখুন।",
      nCtxMaxLabel: "কনটেক্সট সর্বোচ্চ সীমা (n_ctx_max)",
      nCtxMaxPlaceholder: "32768",
      nCtxMaxDesc: "ONP_CHAT_LLM_CTX_MAX। স্বয়ংক্রিয়-সনাক্তের উপরের সীমা। ডিফল্ট ৩২৭৬৮।",
  ...
  setupBanner: {
    ...
    degraded: "Open notebook+ ডিগ্রেডেড অবস্থায় চলছে",
