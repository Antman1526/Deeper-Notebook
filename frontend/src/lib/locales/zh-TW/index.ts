export const zhTW = {
  ...
  settings: {
    ...
    launcherPrefs: {
      ...
      draftModelPathDesc: "llama.cpp 推測式解碼所用小型 GGUF 的絕對路徑（OPEN_NOTEBOOK_LOCAL_DRAFT_MODEL_PATH）。留空則停用。",
      draftNPredictLabel: "每次驗證的草稿令牌數",
      draftNPredictPlaceholder: "8",
      draftNPredictDesc: "OPEN_NOTEBOOK_LOCAL_DRAFT_N_PREDICT。預設 8。",
      nCtxLabel: "本地上下文視窗（n_ctx）",
      nCtxPlaceholder: "32768",
      nCtxDesc: "ONP_CHAT_LLM_CTX。覆蓋從 GGUF 自動偵測的上下文長度。留空則自動偵測。",
      nCtxMaxLabel: "上下文視窗上限（n_ctx_max）",
      nCtxMaxPlaceholder: "32768",
      nCtxMaxDesc: "ONP_CHAT_LLM_CTX_MAX。自動偵測上下文長度的上限。預設 32768。",
      saveButton: "儲存偏好設定",
      saveSuccess: "偏好設定已儲存。",
      saveFailed: "儲存偏好設定失敗。",
  ...
  setupBanner: {
    ...
    goToSettings: "前往設定",
    viewDocs: "查看文件",
    degraded: "Open notebook+ 正在降級狀態下執行",
