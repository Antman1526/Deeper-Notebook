export const ptBR = {
  ...
  knowledge: { mounts: "Cofres montados", scan: "Escanear cofre", status: "Status", readOnly: "Arquivo externo somente leitura", backlinks: "Links de entrada", outgoing: "Links de saída", properties: "Propriedades", tags: "Tags", unresolved: "Link não resolvido", loadError: "Não foi possível carregar o conhecimento.", description: "Leia notas locais do Obsidian e Logseq sem alterar os originais.", files: "Arquivos do cofre", mountsLoading: "Carregando cofres montados…", noMounts: "Ainda não há cofres montados disponíveis.", filesLoading: "Carregando arquivos…", reader: "Leitor", localGraph: "Grafo local", selectNote: "Selecione uma nota para explorá-la", externalReadOnly: "Seu cofre permanece externo e somente leitura.", noteLoading: "Carregando nota…", untitledNote: "Nota sem título", canonicalSource: "fonte canônica", noProperties: "Sem propriedades.", noTags: "Sem tags.", outline: "Estrutura", graphLoading: "Carregando grafo…", graphLoadError: "Não foi possível carregar o grafo.", noteLinks: "Links da nota", linksLoading: "Carregando links…", linksLoadError: "Não foi possível carregar os links.", filterFiles: "Filtrar arquivos", noMatchingFiles: "Nenhum arquivo correspondente.", noGraphLinks: "Ainda não há links de nota para mapear.", noLinks: "Ainda não há links.", openTabs: "Abas abertas", closeTab: "Fechar {{title}}", knowledgeWorkspace: "Área de trabalho de conhecimento", knowledgePane: "Painel de conhecimento", splitPaneRight: "Dividir painel à direita", splitPaneDown: "Dividir painel para baixo", closePane: "Fechar painel", resizeHorizontalSplit: "Redimensionar divisão horizontal", resizeVerticalSplit: "Redimensionar divisão vertical", workspaceLoading: "Carregando a área de trabalho salva…", workspaceLoadError: "Não foi possível carregar a área de trabalho salva. As abas locais continuam disponíveis.", workspaceSaving: "Salvando a área de trabalho…", workspaceSaveError: "Não foi possível salvar a área de trabalho. As abas locais continuam abertas.",
    overlay: { name: "Sobreposição do Deeper Notebook", writable: "Nota própria do aplicativo com gravação", today: "Hoje", newUnique: "Nova nota exclusiva", uniqueTitle: "Título da nota exclusiva", create: "Criar nota", creating: "Criando nota…", daily: "Diárias", notes: "Notas", empty: "Ainda não há notas da sobreposição", loadError: "Não foi possível carregar as notas da sobreposição.", createError: "Não foi possível criar a nota da sobreposição." },
