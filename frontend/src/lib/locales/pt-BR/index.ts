export const ptBR = {
  ...
  filesystem: {
    ...
    downloads: "Downloads",
    defaultExports: "Exportações ONP",
  ...
  settings: {
    ...
    launcherPrefs: {
      ...
      draftModelPathDesc: "Caminho absoluto para um GGUF pequeno para decodificação especulativa do llama.cpp (OPEN_NOTEBOOK_LOCAL_DRAFT_MODEL_PATH). Deixe em branco para desativar.",
      draftNPredictLabel: "Tokens draft por verificação",
      draftNPredictPlaceholder: "8",
      draftNPredictDesc: "OPEN_NOTEBOOK_LOCAL_DRAFT_N_PREDICT. Padrão 8.",
      nCtxLabel: "Janela de contexto local (n_ctx)",
      nCtxPlaceholder: "32768",
      nCtxDesc: "ONP_CHAT_LLM_CTX. Substitui o comprimento de contexto detectado automaticamente do GGUF.",
      nCtxMaxLabel: "Limite máximo de contexto (n_ctx_max)",
      nCtxMaxPlaceholder: "32768",
      nCtxMaxDesc: "ONP_CHAT_LLM_CTX_MAX. Limite superior na detecção automática de contexto. Padrão 32768.",
  ...
  setupBanner: {
    ...
    degraded: "Open notebook+ está rodando em estado degradado",
