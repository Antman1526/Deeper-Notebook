export const esES = {
  ...
  knowledge: { mounts: "Bóvedas montadas", scan: "Escanear bóveda", status: "Estado", readOnly: "Archivo externo de solo lectura", backlinks: "Enlaces entrantes", outgoing: "Enlaces salientes", properties: "Propiedades", tags: "Etiquetas", unresolved: "Enlace sin resolver", loadError: "No se pudo cargar el conocimiento.", description: "Lee notas locales de Obsidian y Logseq sin cambiar los originales.", files: "Archivos de la bóveda", mountsLoading: "Cargando bóvedas montadas…", noMounts: "Aún no hay bóvedas montadas disponibles.", filesLoading: "Cargando archivos…", reader: "Lector", localGraph: "Grafo local", selectNote: "Selecciona una nota para explorarla", externalReadOnly: "Tu bóveda permanece externa y de solo lectura.", noteLoading: "Cargando nota…", untitledNote: "Nota sin título", canonicalSource: "fuente canónica", noProperties: "Sin propiedades.", noTags: "Sin etiquetas.", outline: "Esquema", graphLoading: "Cargando grafo…", graphLoadError: "No se pudo cargar el grafo.", noteLinks: "Enlaces de la nota", linksLoading: "Cargando enlaces…", linksLoadError: "No se pudieron cargar los enlaces.", filterFiles: "Filtrar archivos", noMatchingFiles: "No hay archivos coincidentes.", noGraphLinks: "Aún no hay enlaces de nota para mapear.", noLinks: "Aún no hay enlaces.", openTabs: "Pestañas abiertas", closeTab: "Cerrar {{title}}", knowledgeWorkspace: "Espacio de trabajo de conocimiento", knowledgePane: "Panel de conocimiento", splitPaneRight: "Dividir panel a la derecha", splitPaneDown: "Dividir panel hacia abajo", closePane: "Cerrar panel", resizeHorizontalSplit: "Redimensionar división horizontal", resizeVerticalSplit: "Redimensionar división vertical", workspaceLoading: "Cargando el espacio de trabajo guardado…", workspaceLoadError: "No se pudo cargar el espacio de trabajo guardado. Las pestañas locales siguen disponibles.", workspaceSaving: "Guardando el espacio de trabajo…", workspaceSaveError: "No se pudo guardar el espacio de trabajo. Las pestañas locales siguen abiertas.",
    overlay: { name: "Capa de Deeper Notebook", writable: "Nota propia de la aplicación con escritura", today: "Hoy", newUnique: "Nueva nota única", uniqueTitle: "Título de la nota única", create: "Crear nota", creating: "Creando nota…", empty: "Aún no hay notas de la capa", loadError: "No se pudieron cargar las notas de la capa.", createError: "No se pudo crear la nota de la capa." },
