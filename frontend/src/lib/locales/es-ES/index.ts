export const esES = {
  ...
  filesystem: {
    ...
    downloads: "Descargas",
    defaultExports: "Exportaciones ONP",
  ...
  settings: {
    ...
    launcherPrefs: {
      ...
      draftModelPathDesc: "Ruta absoluta a un GGUF pequeño para la decodificación especulativa de llama.cpp (OPEN_NOTEBOOK_LOCAL_DRAFT_MODEL_PATH). Dejar en blanco para desactivar.",
      draftNPredictLabel: "Tokens borrador por verificación",
      draftNPredictPlaceholder: "8",
      draftNPredictDesc: "OPEN_NOTEBOOK_LOCAL_DRAFT_N_PREDICT. Predeterminado: 8.",
      nCtxLabel: "Ventana de contexto local (n_ctx)",
      nCtxPlaceholder: "32768",
      nCtxDesc: "ONP_CHAT_LLM_CTX. Sobreescribe la longitud de contexto detectada automáticamente del GGUF. Dejar en blanco para detección automática.",
      nCtxMaxLabel: "Límite máximo de contexto (n_ctx_max)",
      nCtxMaxPlaceholder: "32768",
      nCtxMaxDesc: "ONP_CHAT_LLM_CTX_MAX. Límite superior de detección automática. Predeterminado: 32768.",
  ...
  setupBanner: {
    ...
    degraded: "Open notebook+ se está ejecutando en estado degradado",
