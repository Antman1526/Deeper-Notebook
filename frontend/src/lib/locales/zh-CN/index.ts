export const zhCN = {
  ...
  settings: {
    ...
    launcherPrefs: {
      ...
      draftModelPathDesc: "llama.cpp 推测解码所用小型 GGUF 的绝对路径（OPEN_NOTEBOOK_LOCAL_DRAFT_MODEL_PATH）。留空则禁用。",
      draftNPredictLabel: "每次验证的草稿令牌数",
      draftNPredictPlaceholder: "8",
      draftNPredictDesc: "OPEN_NOTEBOOK_LOCAL_DRAFT_N_PREDICT。默认 8。",
      nCtxLabel: "本地上下文窗口（n_ctx）",
      nCtxPlaceholder: "32768",
      nCtxDesc: "ONP_CHAT_LLM_CTX。覆盖从 GGUF 自动检测的上下文长度。留空则自动检测。",
      nCtxMaxLabel: "上下文窗口上限（n_ctx_max）",
      nCtxMaxPlaceholder: "32768",
      nCtxMaxDesc: "ONP_CHAT_LLM_CTX_MAX。自动检测上下文长度的上限。默认 32768。",
      saveButton: "保存偏好",
      saveSuccess: "偏好已保存。",
      saveFailed: "保存偏好失败。",
  ...
  setupBanner: {
    ...
    goToSettings: "前往设置",
    viewDocs: "查看文档",
    degraded: "Open notebook+ 正在降级状态下运行",
