...
- **✨ v0.8.71 — Aurora visual system: launch intro, hero glow-up, smoother streaming**
  ...
  - **📝 Deferred (follow-up):** list virtualization for the sources column + long chat sessions, token batching for source-chat/ask, chat-bubble visual restyle, and prefetch-on-hover/row-memoization — higher-risk items that warrant real long-list/streaming validation in the webview.
