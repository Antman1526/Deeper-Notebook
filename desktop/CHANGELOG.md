...
- **✨ v0.8.68 — Offline/online smart switching + Offline-mode toggle**
  ...
  - **✨ Podcast reliability + capability pass:**
    ...
    - **Deferred (library limitations, documented):** per-stage progress (podcast-creator exposes no progress callbacks), job cancellation (surreal-commands has no cancel API), and outline-review-before-TTS (needs a podcast-creator workflow change).
