...
class ObjectModel(BaseModel):
    ...
    async def save(self) -> None:
        ...
        try:
            ...
            # Use aware UTC datetime objects. The SurrealDB driver serializes
            # these to its native datetime type; pre-serializing with
            # isoformat() sends a string and violates schemafull datetime
            # fields such as credential.created.
            ...
            if self.id is None:
                ...
                # repo_update normalizes legacy strings and preserves native
                # datetime values, so keep the typed field intact here.
