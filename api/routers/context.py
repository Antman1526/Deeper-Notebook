...
async def get_notebook_context(notebook_id: str, context_request: ContextRequest):
    ...
    try:
        ...
        # v0.7.183 — bubble NotFoundError to the global handler
        # (→ 404). Without this, Notebook.get() raising NotFoundError
        # for a missing notebook_id falls through to `except Exception`
        # and returns 500. The explicit InvalidInputError handler
        # below stays — keeps the 400 with str(e) message form.
        raise
