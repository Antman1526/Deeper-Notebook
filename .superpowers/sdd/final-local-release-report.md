...
- **Artifacts:** bundle ID `com.antman1526.open-notebook-plus`, version/build `0.8.114`, arm64 app and bundled Surreal. SHA-256: app executable `1d48e549250d9359fe05e81487d95a9900b1fe26a4f01cec9ce700e4a9808bb6`, bundled Surreal `0afb5d9f0eb8902b5d0e9633c15898ddd2d3f8a259904174c9bc9e1ec1df5002`, DMG `4ece62e4a315a309167313b00ecd411a30e990bb4c153ba1fe99b6b5eb8279e1`.
- **Recoverable install:** the prior app was moved to `/Applications/Deeper Notebook.app.backup-20260821T201559Z`; the staged bundle was copied with `ditto`. Installed/staged executable and Surreal hashes match, and installed deep/strict codesign passes. The older Task 8 backups and pre-final `dist` moved to Downloads remain preserved.
- **Final release smoke:** the hardened runner through `cbf03876` passed staged receipts at `/private/tmp/deeper-notebook-final-staged-20260821T201559Z/` and installed receipts at `/private/tmp/deeper-notebook-final-installed-20260821T201559Z/`. Default proves all six features and the Gemini Forward Light/V2 shell. Explicit off proves the usable Sources page with only `sourceVisuals=false`. Both use GET-only loopback traffic, emit no visual mutation request, and shut down cleanly with no process left behind.
